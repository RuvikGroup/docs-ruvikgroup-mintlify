...
```bash
keytool -exportcert -alias my-key-alias -keystore android/app/brand.keystore -storepass STORE_PASSWORD -keypass KEY_PASSWORD | openssl sha1 -binary | openssl base64
```
